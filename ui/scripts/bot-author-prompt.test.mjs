...
test("agent bot-authoring prompt requires approval and uses the live hub API", async () => {
  ...
  assert.match(prompt, /\{\{GITBOT_URL\}\}\/bots/);
  assert.match(prompt, /Do not edit `bots\.json` directly/);
